...
public final class ReflectionUtils {
    ...
    public static Object invokeMethod(String className, PackageType packageType, String methodName, Object... arguments)
        ...
        return invokeMethod(packageType.getClass(className).getDeclaredClasses()[0], methodName, arguments);
    }
    ...
    public enum PackageType {
        ...
        public static boolean isHigherVersion(int version) {
            return Integer.parseInt(getServerVersion().replace("_", "").split("R")[0].split("v")[1]) >= version;
        }
    ...
    public static void sendPacket(Player player, Object packet) {
        try {
            ...
            playerConnection.getClass().getMethod("sendPacket", PackageType.MINECRAFT_SERVER.getClass("Packet")).invoke(playerConnection, packet);
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
